...
export const weeklyQuests: Quest[] = [
  ...
  { id: 'weekly-steps-hard-1', title: 'Walk 60,000 steps', type: 'weekly', activity: 'steps', unit: 'steps', target: 60000, rewardXP: 700, rewardCoins: 500, difficulty: 'hard', icon: 'Footprints' },
  { id: 'weekly-steps-hard-2', title: 'Walk 80,000 steps', type: 'weekly', activity: 'steps', unit: 'steps', target: 65000, rewardXP: 750, rewardCoins: 600, difficulty: 'hard', icon: 'Footprints' },
  { id: 'weekly-steps-hard-3', title: 'Walk 100,000 steps', type: 'weekly', activity: 'steps', unit: 'steps', target: 75000, rewardXP: 800, rewardCoins: 700, difficulty: 'hard', icon: 'Footprints' },
  ...
  { id: 'weekly-distance-hard-1', title: 'Travel 50 km', type: 'weekly', activity: 'distance', unit: 'km', target: 50, rewardXP: 700, rewardCoins: 500, difficulty: 'hard', icon: 'Ruler' },
  { id: 'weekly-distance-hard-2', title: 'Travel 55 km', type: 'weekly', activity: 'distance', unit: 'km', target: 55, rewardXP: 750, rewardCoins: 600, difficulty: 'hard', icon: 'Ruler' },
  { id: 'weekly-distance-hard-3', title: 'Travel 60 km', type: 'weekly', activity: 'distance', unit: 'km', target: 60, rewardXP: 800, rewardCoins: 700, difficulty: 'hard', icon: 'Ruler' },
  ...
  { id: 'weekly-calories-hard-1', title: 'Burn 15000 kcal', type: 'weekly', activity: 'calories', unit: 'kcal', target: 15000, rewardXP: 700, rewardCoins: 500, difficulty: 'hard', icon: 'Flame' },
  { id: 'weekly-calories-hard-2', title: 'Burn 17500 kcal', type: 'weekly', activity: 'calories', unit: 'kcal', target: 17500, rewardXP: 750, rewardCoins: 600, difficulty: 'hard', icon: 'Flame' },
  { id: 'weekly-calories-hard-3', title: 'Burn 20000 kcal', type: 'weekly', activity: 'calories', unit: 'kcal', target: 20000, rewardXP: 800, rewardCoins: 700, difficulty: 'hard', icon: 'Flame' },
  ...
  { id: 'weekly-sleep-hard-1', title: 'Sleep 54 h', type: 'weekly', activity: 'sleep', unit: 'h', target: 54, rewardXP: 700, rewardCoins: 500, difficulty: 'hard', icon: 'MoonStar' },
  { id: 'weekly-sleep-hard-2', title: 'Sleep 56 h', type: 'weekly', activity: 'sleep', unit: 'h', target: 56, rewardXP: 750, rewardCoins: 600, difficulty: 'hard', icon: 'MoonStar' },
  { id: 'weekly-sleep-hard-3', title: 'Sleep 58 h', type: 'weekly', activity: 'sleep', unit: 'h', target: 58, rewardXP: 800, rewardCoins: 700, difficulty: 'hard', icon: 'MoonStar' },
  ...
  { id: 'weekly-AZM-hard-3', title: 'Be active for 400 min', type: 'weekly', activity: 'AZM', unit: 'm', target: 400, rewardXP: 800, rewardCoins: 700, difficulty: 'hard', icon: 'Zap' },
